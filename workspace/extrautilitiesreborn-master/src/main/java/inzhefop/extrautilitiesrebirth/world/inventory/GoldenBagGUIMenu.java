...
public class GoldenBagGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GoldenBagGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ExtrautilitiesrebirthModMenus.GOLDEN_BAG_GUI.get(), id);
