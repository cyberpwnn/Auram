...
public class FurnaceGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnaceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ExtrautilitiesrebirthModMenus.FURNACE_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 98, 33) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 8, 18) {
		}));
