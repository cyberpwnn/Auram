...
public class EnderQuarryGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnderQuarryGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ExtrautilitiesrebirthModMenus.ENDER_QUARRY_GUI.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 98, 38) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
