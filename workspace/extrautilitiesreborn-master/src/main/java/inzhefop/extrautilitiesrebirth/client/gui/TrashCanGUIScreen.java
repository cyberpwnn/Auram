...
public class TrashCanGUIScreen extends AbstractContainerScreen<TrashCanGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/trash_can_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.literal("Trash-Can"), 7, 5, -12829636, false);
	}
