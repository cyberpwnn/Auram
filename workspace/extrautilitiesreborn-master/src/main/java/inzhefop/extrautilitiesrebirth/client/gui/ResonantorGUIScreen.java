...
public class ResonantorGUIScreen extends AbstractContainerScreen<ResonantorGUIMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		// We use the 9-arg blit to ensure the texture size matches the draw size, preventing UV scaling issues on small textures
		...
		guiGraphics.blit(new ResourceLocation("extrautilitiesrebirth:textures/arrow.png"),
				this.leftPos + 62, this.topPos + 33, 0, 0, 32, 18, 32, 18);

		// Logic for Progress Arrow
		double fdf = 0;
		fdf = (new Object() {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.literal("Resonator"), 7, 4, -12829636, false);
	}
