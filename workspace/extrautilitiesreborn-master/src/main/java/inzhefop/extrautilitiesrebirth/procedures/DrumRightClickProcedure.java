...
public class DrumRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level().isClientSide())
			_player.displayClientMessage(Component.literal(("Drum-Fill: " + (((Math.round(new Object() {
			...
			}.getFluidTankLevel(world, BlockPos.containing(x, y, z), 1)) + " / ") + "" + Math.round(new Object() {
			...
			}.getFluidTankCapacity(world, BlockPos.containing(x, y, z), 1))) + " mB"))), (false));
	}
}
