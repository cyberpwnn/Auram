...
public class SolarPanelUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (ExtrautilitiesrebirthModBlocks.SOLAR_PANEL.get() == (world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock()) {
			if (new Object() {
				public boolean canReceiveEnergy(LevelAccessor level, BlockPos pos) {
					AtomicBoolean _retval = new AtomicBoolean(false);
					BlockEntity _ent = level.getBlockEntity(pos);
		...
		if (ExtrautilitiesrebirthModBlocks.SOLAR_PANEL.get() == (world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock()) {
			if (new Object() {
				public boolean canReceiveEnergy(LevelAccessor level, BlockPos pos) {
					AtomicBoolean _retval = new AtomicBoolean(false);
					BlockEntity _ent = level.getBlockEntity(pos);
