...
public class CulinaryGeneratorUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (false == (new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "redinv")) || true == (new Object() {
			public boolean getValue(LevelAccessor world, BlockPos pos, String tag) {
				BlockEntity blockEntity = world.getBlockEntity(pos);
				if (blockEntity != null)
					return blockEntity.getPersistentData().getBoolean(tag);
		...
		}.getValue(world, BlockPos.containing(x, y, z), "redinv"))
				&& (world instanceof Level _lvl_isPow ? _lvl_isPow.hasNeighborSignal(BlockPos.containing(x, y, z)) : false)) {
			itemvalid = ((new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem().isEdible() ? (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem().getFoodProperties().getNutrition() : 0) > 0;
			multiplier = 1;
			if (ExtrautilitiesrebirthModItems.SPEED_UPGRADE.get() == (new Object() {
				...
				}.getAmount(world, BlockPos.containing(x, y, z), 1) * 1.05;
			}
			if (ExtrautilitiesrebirthModItems.ENCHANTED_SPEED_UPGRADE.get() == (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			if (ExtrautilitiesrebirthModItems.SUPER_SPEED_UPGRADE.get() == (new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
				...
				}.getAmount(world, BlockPos.containing(x, y, z), 1) * 1.2;
			}
			burntime = 600;
			energytick = ((new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
					if (_ent != null)
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem().getFoodProperties().getNutrition() : 0) * 6 * multiplier;
			if (new Object() {
			...
			}.getMaxEnergyStored(world, BlockPos.containing(x, y, z)) && itemvalid && new Object() {
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						_blockEntity.getPersistentData().putDouble("time", burntime);
			...
			if (new Object() {
				...
				UpdateRGBProcedure.execute(world, x, y, z);
				if (!world.isClientSide()) {
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockEntity _blockEntity = world.getBlockEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
					if (_blockEntity != null)
						...
						}.getValue(world, BlockPos.containing(x, y, z), "time")) - 1 * multiplier));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
				{
					BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
					int _amount = (int) energytick;
					if (_ent != null)
			...
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getPersistentData().putBoolean("valid", (itemvalid || new Object() {
						public double getValue(LevelAccessor world, BlockPos pos, String tag) {
							BlockEntity blockEntity = world.getBlockEntity(pos);
							if (blockEntity != null)
								return blockEntity.getPersistentData().getDouble(tag);
			...
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getPersistentData().putDouble("progress2", (((new Object() {
						public double getValue(LevelAccessor world, BlockPos pos, String tag) {
							BlockEntity blockEntity = world.getBlockEntity(pos);
							if (blockEntity != null)
								return blockEntity.getPersistentData().getDouble(tag);
					...
					}.getValue(world, BlockPos.containing(x, y, z), "time")) / burntime) * 22));
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
		}
		...
		if (new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "burnticks") > 0) {
			if (!world.isClientSide()) {
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockEntity _blockEntity = world.getBlockEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getPersistentData().putString("production", ("Output: " + (Math.round(output) + " Fe/t")));
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
		} else {
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getPersistentData().putString("production", ("Output: " + (0 + " Fe/t")));
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
		}
		if (!world.isClientSide()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_blockEntity != null)
				_blockEntity.getPersistentData().putString("seconds", (Math.round((new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getDouble(tag);
				...
				}.getValue(world, BlockPos.containing(x, y, z), "burnticks")) / 20) + "s"));
			if (world instanceof Level _level)
				_level.sendBlockUpdated(_bp, _bs, _bs, 3);
		}
	}
