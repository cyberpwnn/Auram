...
public class DiamondSpikeBlock extends Block {
	public DiamondSpikeBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.METAL).strength(10f, 1000f).noOcclusion()
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(ExtrautilitiesrebirthModBlocks.DIAMOND_SPIKE.get(), renderType -> renderType == RenderType.cutout());
	}
}
