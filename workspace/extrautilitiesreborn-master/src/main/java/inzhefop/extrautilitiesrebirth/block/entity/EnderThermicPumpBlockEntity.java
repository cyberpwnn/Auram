...
public class EnderThermicPumpBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	private final FluidTank fluidTank = new FluidTank(64000, fs -> {
