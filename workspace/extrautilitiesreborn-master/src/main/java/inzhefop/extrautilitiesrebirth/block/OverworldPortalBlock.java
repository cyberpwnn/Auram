...
public class OverworldPortalBlock extends Block {
	public OverworldPortalBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.STONE).strength(2f, 30f).lightLevel(s -> 8));
	}
	...
	public void stepOn(Level world, BlockPos pos, BlockState blockstate, Entity entity) {
		...
		OverworldPortalEntityWalksOnTheBlockProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		OverworldPortalOnBlockRightClickedProcedure.execute(world, x, y, z, entity);
