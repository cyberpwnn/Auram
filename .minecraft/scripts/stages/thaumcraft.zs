...
mods.ItemStages.stageModItems("thaumic-mage", "thaumicadditions");
mods.ItemStages.stageModItems("thaumic-mage", "thaumicaugmentation");
mods.ItemStages.stageModItems("thaumic-mage", "thaumicbrewing");
mods.ItemStages.stageModItems("thaumic-mage", "thaumicenergistics");
mods.ItemStages.stageModItems("thaumic-mage", "thaumicperiphery");
