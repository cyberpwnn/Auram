...
//REMOVE BASES
recipies.remove(<mekanism:controlcircuit>);
recipies.remove(<mekanism:controlcircuit:1>);
recipies.remove(<mekanism:controlcircuit:2>);
recipies.remove(<mekanism:controlcircuit:3>);
