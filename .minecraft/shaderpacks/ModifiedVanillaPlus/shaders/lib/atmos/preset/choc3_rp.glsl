...
void make_colors() {
    vec3 sunlightSunrise;
        ...
        sunlightSunrise.g   = 0.61;
        sunlightSunrise.b   = 0.17;
        sunlightSunrise    *= 1.0;
    ...
    vec3 sunlightSunset;
        ...
        sunlightSunset.g    = 0.61;
        sunlightSunset.b    = 0.17;
        sunlightSunset     *= 1.0;
    ...
    vec3 skylightSunset;
        skylightSunset.r    = 0.78;
        skylightSunset.g    = 0.78;
    ...
    light_flip  = saturate(1.0-lf);
        ...
        sky_color[0]    = color_saturation(linear_sky, 0.9) * 0.9 * vec3(1.0, 1.35, 1.0);
